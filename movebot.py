...
PATH='./CNN_v3.pt'
Outputs = {'0':'left','2':'u','1':'right','3':'stop','4':'na'}
#---------- My code ---------------------##---------- My code ---------------------#
...
def threaded_image_handling(cv2_img):
	...
	#print (curr_x, curr_y, pos_y, pos_x, active_x, active_y)
	global h,c
	#---------- My code ---------------------#
...
def laser_callback(msg):
	...
	if laser_running == True:
		...
		dist = msg.ranges[0]
		thr = front_wall_thr
		#print(np.argsort(np.array(msg.ranges)))
		#print(msg.ranges)
		np.save('lidar_Data.npy',np.array(msg.ranges))
		if dist > thr:
